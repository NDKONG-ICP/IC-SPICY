...
import { idlFactory } from './api_gateway.did.js';
export { idlFactory } from './api_gateway.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_API_GATEWAY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./api_gateway.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the api_gateway canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./api_gateway.did.js")._SERVICE>}
 */
export const api_gateway = createActor(canisterId);
