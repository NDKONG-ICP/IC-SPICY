...
import { idlFactory } from './wallet2.did.js';
export { idlFactory } from './wallet2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WALLET2;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wallet2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wallet2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wallet2.did.js")._SERVICE>}
 */
export const wallet2 = createActor(canisterId);
