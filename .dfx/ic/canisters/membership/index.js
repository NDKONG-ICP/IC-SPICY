...
import { idlFactory } from './membership.did.js';
export { idlFactory } from './membership.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MEMBERSHIP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./membership.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the membership canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./membership.did.js")._SERVICE>}
 */
export const membership = createActor(canisterId);
