...
export { idlFactory } from './deepseek_agent.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DEEPSEEK_AGENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./deepseek_agent.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the deepseek_agent canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./deepseek_agent.did.js")._SERVICE>}
 */
export const deepseek_agent = createActor(canisterId);
