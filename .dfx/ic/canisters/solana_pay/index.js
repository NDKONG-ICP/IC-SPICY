...
import { idlFactory } from './solana_pay.did.js';
export { idlFactory } from './solana_pay.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SOLANA_PAY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./solana_pay.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the solana_pay canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./solana_pay.did.js")._SERVICE>}
 */
export const solana_pay = createActor(canisterId);
