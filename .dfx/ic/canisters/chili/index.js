...
import { idlFactory } from './chili.did.js';
export { idlFactory } from './chili.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CHILI;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./chili.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the chili canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./chili.did.js")._SERVICE>}
 */
export const chili = createActor(canisterId);
