...
import { idlFactory } from './shop.did.js';
export { idlFactory } from './shop.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SHOP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./shop.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the shop canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./shop.did.js")._SERVICE>}
 */
export const shop = createActor(canisterId);
