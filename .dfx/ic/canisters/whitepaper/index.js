...
import { idlFactory } from './whitepaper.did.js';
export { idlFactory } from './whitepaper.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WHITEPAPER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./whitepaper.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the whitepaper canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./whitepaper.did.js")._SERVICE>}
 */
export const whitepaper = createActor(canisterId);
