...
import { idlFactory } from './test_staking.did.js';
export { idlFactory } from './test_staking.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TEST_STAKING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test_staking.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test_staking canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test_staking.did.js")._SERVICE>}
 */
export const test_staking = createActor(canisterId);
