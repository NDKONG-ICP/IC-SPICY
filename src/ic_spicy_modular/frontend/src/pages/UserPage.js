      ...
      <div className="space-y-8">
        ...
        {!isConnected ? (
          ...
          <>
            ...
            {/* Co-op Member Logistics Access */}
            {membershipTier === 'Elite' && (
              <div className="glass-card-dark p-6 border border-green-500/30 bg-gradient-to-br from-green-500/10 to-emerald-500/10">
                <div className="flex items-center mb-4">
                  <div className="text-2xl mr-3">🚛</div>
                  <h2 className="text-2xl font-bold text-green-400">Co-op Logistics Portal</h2>
                </div>
                <div className="text-center">
                  <p className="text-gray-300 mb-6">
                    As a Co-op member, you have exclusive access to the IC Spicy Logistics dApp for managing 
                    supply chain operations, inventory tracking, and distribution coordination.
                  </p>
                  <a
                    href="https://icspicy-logistics-ynt.caffeine.xyz"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center px-8 py-4 rounded-lg bg-gradient-to-r from-green-500 to-emerald-500 text-white font-medium hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-xl"
                  >
                  ...
                  <div className="mt-4 text-sm text-gray-400">
                    <p>🔐 Exclusive access for Co-op members only</p>
                    <p>📊 Real-time supply chain management</p>
                    <p>🌶️ Inventory tracking for IC Spicy products</p>
                  </div>
                </div>
              </div>
            )}
